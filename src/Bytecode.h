...
struct Bytecode { std::vector<Instruction> instructions;std::vector<std::shared_ptr<FunctionPrototype>>functions;std::vector<HandlerRegion>handlers; };
