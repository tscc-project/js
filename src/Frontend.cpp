...
bool Lexer::lex(std::vector<Token>&out,Diagnostic&d){
 ...
 while(i<source_.size()){
  ...
  if(std::isalpha(static_cast<unsigned char>(c))||c=='_'||c=='$'){
   ...
   auto text=source_.substr(start,i-start);const bool keyword=text=="let"||text=="const"||text=="var"||text=="true"||text=="false"||text=="null"||text=="undefined"||text=="if"||text=="else"||text=="while"||text=="for"||text=="break"||text=="continue"||text=="function"||text=="return"||text=="throw"||text=="this"||text=="new";
